...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onResume() {
        ...
        if (uri != null && uri.toString().startsWith(Imgur.REDIRECT_URL)) {
            Uri temp = Uri.parse("https://treehouseworkshop.com?" + uri.getFragment());
            OAuthUtil.set(OAuthUtil.ACCESS_TOKEN, temp.getQueryParameter(OAuthUtil.ACCESS_TOKEN));
            OAuthUtil.set(OAuthUtil.EXPIRES_IN, System.currentTimeMillis() + (Long.MAX_VALUE));
    ...
    private void upload() {
        ...
        try {
            ...
            Service.getAuthedApi().uploadImages(RequestBody.create(
                    MediaType.parse("image/jpeg"), image
